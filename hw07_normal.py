...
# Правильно ли тестирование класса People? Где тут ошибка?


class Student(People):
    def __init__(self, name, surname, patronymic, mom, dad, school_class):
    ...
    if __name__ == '__main__':
        ...
        st_2 = Student('Сергей', 'Сергеевич', 'Сергеев', 'Ольга Сергеева', 'Андрей Сергеев', '5б')
        st_3 = Student('Олег', 'Олегович', 'Петров', 'Юлия Петрова', 'Олег Петров', '6а')
